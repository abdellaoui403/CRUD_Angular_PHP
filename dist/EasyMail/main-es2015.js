...
class AddComponent {
    constructor(formBuilder, clientsService, router) {
    ...
    onSubmit() {
        this.clientsService.createClient(this.addForm.value).subscribe(data => {
...
AddComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddComponent, selectors: [["app-add"]], decls: 31, vars: 1, consts: [[1, "grid_test"], [1, "row"], [1, "form"], [3, "formGroup", "ngSubmit"], [1, "col-1-of-3"], [1, "required"], ["type", "text", "name", "CNom", "id", "CNom", "formControlName", "CNom", 1, "CNom"], ["type", "text", "name", "CPrenom", "id", "CPrenom", "formControlName", "CPrenom", 1, "CPrenom"], ["type", "text", "name", "CAge", "id", "CAge", "formControlName", "CAge", 1, "CAge"], [3, "click"]], template: function AddComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AddComponent_Template_form_ngSubmit_5_listener() { return ctx.onSubmit(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddComponent_Template_button_click_29_listener() { return ctx.onSubmit(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _clients_service__WEBPACK_IMPORTED_MODULE_2__["ClientsService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
...
/* harmony import */ var _modify_modify_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modify/modify.component */ "./src/app/modify/modify.component.ts");
...
const routes = [
    { path: '', component: _show_show_component__WEBPACK_IMPORTED_MODULE_3__["ShowComponent"] },
    { path: 'List', component: _show_show_component__WEBPACK_IMPORTED_MODULE_3__["ShowComponent"] },
    ...
    { path: 'Modify', component: _modify_modify_component__WEBPACK_IMPORTED_MODULE_5__["ModifyComponent"] },
    { path: 'Modify/:ID', component: _modify_modify_component__WEBPACK_IMPORTED_MODULE_5__["ModifyComponent"] }
];
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
        ...
        _modify_modify_component__WEBPACK_IMPORTED_MODULE_8__["ModifyComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"]] }); })();
...
class ClientsService {
    ...
    createClient(client) {
        return this.http.post('http://localhost/Api/add.php', client, { responseType: 'text' });
    }
    deleteClient(ID) {
...
class ModifyComponent {
    constructor(formBuilder, clientsService, router, routes) {
        this.formBuilder = formBuilder;
        this.clientsService = clientsService;
        this.router = router;
        this.routes = routes;
    ...
    ngOnInit() {
        ...
        this.clientsService
            .getClientById(routerParams.ID)
            .subscribe((data) => {
            this.addForm.patchValue(data), (this.ID = data["ID"]);
        });
        this.addForm = this.formBuilder.group({
            ID: [""],
            Nom: [""],
    ...
    onSubmit() {
        this.clientsService.updateClient(this.addForm.value).subscribe(data => {
            this.router.navigate(["List"]);
        }, error => {
            console.log(error);
        });
...
ModifyComponent.ɵfac = function ModifyComponent_Factory(t) { return new (t || ModifyComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_clients_service__WEBPACK_IMPORTED_MODULE_2__["ClientsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"])); };
ModifyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ModifyComponent, selectors: [["app-modify"]], decls: 38, vars: 2, consts: [[1, "grid_test"], [1, "row"], [1, "form"], [3, "formGroup", "ngSubmit"], [1, "col-1-of-3"], [1, "required"], ["type", "text", "name", "ID", "id", "ID", "readonly", "", 1, "ID", 3, "value"], ["type", "text", "name", "CNom", "id", "CNom", "formControlName", "Nom", 1, "CNom"], ["type", "text", "name", "CPrenom", "id", "CPrenom", "formControlName", "Prenom", 1, "CPrenom"], ["type", "text", "name", "CAge", "id", "CAge", "formControlName", "Age", 1, "CAge"], [3, "click"]], template: function ModifyComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "h1");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "form", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ModifyComponent_Template_form_ngSubmit_5_listener() { return ctx.onSubmit(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](7, "div", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "span");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ModifyComponent_Template_button_click_36_listener() { return ctx.onSubmit(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ModifyComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _clients_service__WEBPACK_IMPORTED_MODULE_2__["ClientsService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }]; }, null); })();
...
function ShowComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ShowComponent_div_4_Template_input_change_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.RadioChangerHandler($event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function ShowComponent_tr_23_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ShowComponent_tr_23_Template_button_click_10_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const std_r5 = ctx.$implicit; const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.delete(std_r5); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ShowComponent_tr_23_Template_button_click_12_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r7); const std_r5 = ctx.$implicit; const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.update(std_r5); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](13, "i", 16);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const std_r5 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
class ShowComponent {
    ...
    //Delete
    delete(clients) {
        this.clientService.deleteClient(clients["ID"]).subscribe(data => {
            this.clients = this.clients.filter(u => u !== clients);
        });
    }
    update(clients) {
        this.ID = clients["ID"];
...
ShowComponent.ɵfac = function ShowComponent_Factory(t) { return new (t || ShowComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_clients_service__WEBPACK_IMPORTED_MODULE_1__["ClientsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
ShowComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ShowComponent, selectors: [["app-show"]], decls: 24, vars: 3, consts: [[1, "table-title"], [1, "radio"], ["class", "radio_element", 4, "ngFor", "ngForOf"], [1, "searchButton"], ["type", "text", 1, "search", 3, "ngModel", "ngModelChange", "input"], [1, "fas", "fa-search"], [1, "table-fill"], [1, "text-left"], [1, "table-hover"], [4, "ngFor", "ngForOf"], [1, "radio_element"], ["type", "radio", "name", "SelectedFilter", 1, "radio", 3, "value", "change"], [1, "text-left", "action"], [1, "action_delete", 3, "click"], [1, "fas", "fa-trash"], [1, "action_udpate", 3, "click"], [1, "fas", "fa-edit"]], template: function ShowComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ShowComponent_Template_input_ngModelChange_7_listener($event) { return ctx.Text = $event; })("input", function ShowComponent_Template_input_input_7_listener() { return ctx.search(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ShowComponent, [{
    ...
    }], function () { return [{ type: _clients_service__WEBPACK_IMPORTED_MODULE_1__["ClientsService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! C:\Users\pc\Desktop\Angular\EasyMail\src\main.ts */"./src/main.ts");
